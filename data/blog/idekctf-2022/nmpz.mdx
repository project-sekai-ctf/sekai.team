...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <figure>
    <img
      className="w-full"
      src="/static/images/idekctf-2022/4-bollard.png"
  ...
  <figure>
    <img
      className="w-full"
      src="/static/images/idekctf-2022/4-comparison.png"
...
<Tweet id="1564621460034969606">
  > The Kenya Snorkels 🤿 > Beautiful, bombastic &amp; ehm... broombroom?
  [pic.twitter.com/Qy7O6y6Ajg](https://t.co/Qy7O6y6Ajg) > > &mdash; GeoGuessr (@geoguessr) [August
  30, 2022](https://twitter.com/geoguessr/status/1564621460034969606) > ![Screenshot of the tweet by
  GeoGuessr](/static/images/idekctf-2022/5-twitter.png)
</Tweet>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <figure>
    <img
      className="w-full"
      src="/static/images/idekctf-2022/6-bollard.png"
  ...
  <figure>
    <img
      className="w-full"
      src="/static/images/idekctf-2022/6-comparison.png"
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <figure>
    <img
      className="w-full"
      src="/static/images/idekctf-2022/7-plate.png"
  ...
  <figure>
    <img
      className="w-full"
      src="/static/images/idekctf-2022/7-comparison.png"
      alt="Wikimedia Commons example of Mongolian license plate"
    />
    <figcaption className="text-center">
      Mongolian license plate (
      <a href="https://en.wikipedia.org/wiki/Vehicle_registration_plates_of_Mongolia">Wikipedia</a>)
    </figcaption>
  </figure>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <figure>
    <img
      className="w-full"
      src="/static/images/idekctf-2022/11-bollard.png"
  ...
  <figure>
    <img
      className="w-full"
      src="/static/images/idekctf-2022/11-comparison.png"
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <figure>
    <img
      className="w-full"
      src="/static/images/idekctf-2022/14-plate.png"
  ...
  <figure>
    <img
      className="w-full"
      src="/static/images/idekctf-2022/14-comparison.jpg"
    ...
    <figcaption className="text-center">
      ...
      <a href="https://en.wikipedia.org/wiki/Vehicle_registration_plates_of_Ecuador">Wikipedia</a>)
    </figcaption>
  </figure>
</div>
...
<Tweet id="1562906335125336067">
  > Geoguessr players when they fly to Albania and theres no rift in the sky
  [pic.twitter.com/5ER3US0xKL](https://t.co/5ER3US0xKL) > > &mdash; PokemonChallenges (@pChalTV)
  [August 25, 2022](https://twitter.com/pChalTV/status/1562906335125336067) > ![Screenshot of meme
  tweet from @pChalTV](/static/images/idekctf-2022/16-twitter.png)
</Tweet>
