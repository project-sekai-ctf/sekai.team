...
draft: false
authors: ['deuterium']
tags: ['Crypto', 'SDCTF 2022', 'AES', 'z3', 'substitution', 'permutation']
summary: 'Exploiting the structure of sbox used and finding the inverse substitution mapping using z3.'
canonicalUrl: 'https://deut-erium.github.io/ctf-writeups-2022/ctf2022/sdctf/tasty_crypto_roll/2022-05-10-SDCTF-Tasty-Crypto-Roll'
---
